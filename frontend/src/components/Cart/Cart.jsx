...
export default function Cart() {
    ...
    const verifyPayment = async () => {
      ...
      try {
        ...
        if (result.success) {
          ...
          const billingData = sessionStorage.getItem("pending_billing");
  ...
  const validateBillingInfo = () => {
    ...
    } else if (!/^[0-9]{10,11}$/.test(billingInfo.phone.replace(/\s/g, ""))) {
        ...
        {steps.map((step, index) => (
          <Col key={step.key} xs="auto" className="text-center">
            ...
            >
              ...
              <span
                className={`ms-2 ${currentStep === step.key ? "fw-bold" : ""}`}
              >
                {step.label}
              </span>
            ...
            >
              ...
              >
                <div className="d-flex align-items-center">
                  ...
                  />
                  <div className="text-decoration-none text-dark no-underline">
              ...
              <div className="d-flex justify-content-end align-items-center gap-2">
                ...
                >
                  {((item.price + 2000000) * item.quantity).toLocaleString(
                    "vi-VN"
                  )}{" "}
                  đ
                </span>
        ...
        <Card className="p-4">
          ...
          <Form>
            ...
            <div className="d-flex gap-3">
              ...
              <Button variant="primary" onClick={onComplete} className="px-4">
                Hoàn tất đặt hàng
              </Button>
            </div>
          </Form>
